can.Component.extend({
    ...
    view: `
        <div class='container-fluid'>
            ...
            <div class='row'>   
                ...
                <div class='col-2'>      
                    <div class="footer">
                        <button class="dissBtn btn btn-primary btn-lg btn btn-danger"
                        on:click="nope()" >Dislike</button>
                        <button class="likeBtn btn btn-primary btn-lg" 
    ...
    ViewModel: {
      ...
      emptyProfile: {
        default() {
            window.location.href = "https://github.com/KagErou710/dodudone_signup";
        }
      },
